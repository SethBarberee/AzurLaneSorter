...
valid_nations = ['Eagle Union', 'Royal Navy', 'Iron Blood', 'Sakura Empire', 'Dragon Empery', 'Sardegna Empire',
                 'Northern Parliament', 'Iris Libre', 'Vichya Dominion', 'Hololive', 'Neptunia',
                 'Bilibili', 'KizunaAI', 'Utawarerumono', 'Universal', 'Venus Vacation']
